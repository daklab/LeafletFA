...
PROPORTION_NEGATIVE_VALUES=(0.5 0.99)
K_USE_VALUES=(2 3 10)
USE_GLOBAL_PRIOR_VALUES=(True False)
INPUT_CONC_PRIOR_VALUES=(1.0 1000.0 "inf")  # Include "inf" as a string
...
# Set up a directory for storing these results [not doing this for now...]
results_dir=/gpfs/commons/groups/knowles_lab/Karin/Leaflet-Factor/Analysis/simulation
